                ...
                <div class="box-body">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>الوصف</label>
                                <textarea name="description" class="form-control ckeditor"> {{ $material->description }}</textarea>
                            </div>
                        ...
                        <div class="form-group">
                            <label>الوزن</label>
                            <input type="number" name="stock" class="form-control" value="{{ $material->stock }}">
                        </div>
