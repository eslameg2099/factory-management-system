                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('dashboard.clients.orders.update', ['order' => $order->id, 'client' => $client->id]) }}" method="post">
                                ...
                                <h4>المطلوب : <span class="total-price" value="{{ number_format($order->total_price, 2) }}"   id="stt" ></span></h4>

                                <h4>الخصم : <input type="text" name="des"  class="form-control total-pric" value="{{ number_format($order->des, 2) }}"   id="tx"></h4>

                                <h4>الاجمالي : <span class="total-p" name="fin"  value="{{ number_format($order->finprice, 2) }}"  id="finn"  ></span></h4>
